Public Class frm_listado_posiciones
    ...
    Public Property cnn() As String
        ...
        End Set
    End Property
    Private Sub frm_listado_posiciones_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGA_GRILLA()
        ...
        Try
            ...
            class_posicion.rac_codigo = 0
            class_posicion.todos = chkActivo.Checked
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    If ds.Tables(0).Rows(Fila)("pos_codigo") > 0 Then
                        Do While Fila < ds.Tables(0).Rows.Count
                            Grilla.Rows.Add(ds.Tables(0).Rows(Fila)("pos_codigo"),
                                            ds.Tables(0).Rows(Fila)("pos_nombre"),
                                            ds.Tables(0).Rows(Fila)("rac_nombre"),
                                            ds.Tables(0).Rows(Fila)("pos_activo"))
                            Fila = Fila + 1
                        Loop
    ...
    Private Sub ELIMINA_REGISTRO(ByVal codigo As Integer)
        Dim class_posiciones As class_posiciones = New class_posiciones
        Dim ds As DataSet = New DataSet
        ...
        Try
            ds = Nothing
            class_posiciones.cnn = _cnn
            class_posiciones.pos_codigo = codigo

            ds = class_posiciones.POSICION_ELIMINA_REGISTRO(_msgError)
            If _msgError <> "" Then
                ds = Nothing
    ...
    Private Sub Grilla_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles Grilla.CellContentClick
        Try
            If e.ColumnIndex = 4 Then
                Dim frm As frm_ingreso_posicion = New frm_ingreso_posicion
                frm.cnn = _cnn
                frm.pos_codigo = Grilla.Rows(e.RowIndex).Cells(0).Value
                frm.ShowDialog()
                Call CARGA_GRILLA()
