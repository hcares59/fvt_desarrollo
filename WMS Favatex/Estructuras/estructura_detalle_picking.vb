Public Class estructura_detalle_picking
    ...
    Public Property con_fila As Long
    ...
    Public Sub New(ByVal _pic_codigo As Integer, ByVal _pro_codigo As String, ByVal _pro_nombre As String,
                   ...
                   ByVal _rut_cliente As String, ByVal _nombre_cliente As String, ByVal _con_observacion As String, ByVal _pic_fechaocoriginal As Date,
                   ByVal _pic_semodificafecha As Boolean, ByVal _dpp_fila As Integer, ByVal _con_fila As Long)
        ...
        Me.dpp_fila = _dpp_fila
        Me.con_fila = _con_fila
