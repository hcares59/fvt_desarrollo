Public Class frm_listado_tipo_documento
    ...
    Public Property cnn() As String
        ...
        End Set
    End Property
    Private Sub frm_listado_tipo_documento_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGA_GRILLA()
        ...
        Dim classTDOC As class_tipo_documento = New class_tipo_documento
        ...
        Try
            ...
            ds = Nothing
            classTDOC.cnn = _cnn
            classTDOC.tdo_codigo = 0
            classTDOC.todos = chkActivo.Checked

            _msg = ""

            Grilla.Rows.Clear()
            ds = classTDOC.tipodocto_listado(_msg)
            If _msg = "" Then
                If ds.Tables(0).Rows.Count > 0 Then
                    If ds.Tables(0).Rows(Fila)("tdo_codigo") > 0 Then
                        Do While Fila < ds.Tables(0).Rows.Count
                            Grilla.Rows.Add(ds.Tables(0).Rows(Fila)("tdo_codigo"),
                                            ds.Tables(0).Rows(Fila)("tdo_nombre"),
                                            ds.Tables(0).Rows(Fila)("tdo_activo"))
                            Fila = Fila + 1
                        Loop
                ...
                End If
                Me.Text = "LISTADO DE TIPOS DE DOCUMENTOS - [ULTIMA CONSULTA: " + DateTime.Now.ToString() + "]"
            Else
    ...
    Private Sub ButtonNueva_Click(sender As Object, e As EventArgs) Handles ButtonNueva.Click
        Dim frm As frm_ingreso_tipo_documento = New frm_ingreso_tipo_documento
        frm.cnn = _cnn
        frm.ShowDialog()
        Call CARGA_GRILLA()
    End Sub
    ...
    Private Sub Grilla_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles Grilla.CellContentClick
        Try
            If e.ColumnIndex = 3 Then
                Dim frm As frm_ingreso_tipo_documento = New frm_ingreso_tipo_documento
                frm.cnn = _cnn
                frm.tdo_codigo = Grilla.Rows(e.RowIndex).Cells(0).Value
                frm.ShowDialog()
                Call CARGA_GRILLA()
    ...
    Private Sub ELIMINA_REGISTRO(ByVal codigo As Integer)
        ...
        Try
            ds = Nothing
            classTDOC.cnn = _cnn
            classTDOC.tdo_codigo = codigo

            ds = classTDOC.tipoDocto_elimina_registro(_msgError)
            If _msgError <> "" Then
                ds = Nothing
