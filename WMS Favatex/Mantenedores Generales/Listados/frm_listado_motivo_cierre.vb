Public Class frm_listado_motivo_cierre
    ...
    Private Sub frm_listado_motivo_cierre_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGA_GRILLA()
        ...
        Dim class_motivos As class_motivo_cierre = New class_motivo_cierre
        ...
        Try
            ...
            Dim _msg As String
            ds = Nothing
            class_motivos.cnn = _cnn
            class_motivos.mci_codigo = 0
            class_motivos.todos = chkActivo.Checked

            _msg = ""

            Grilla.Rows.Clear()
            ds = class_motivos.MOTIVO_CIERRE_LISTADO(_msg)
            If _msg = "" Then
                If ds.Tables(0).Rows.Count > 0 Then
                    If ds.Tables(0).Rows(Fila)("mci_codigo") > 0 Then
                        Do While Fila < ds.Tables(0).Rows.Count
                            Grilla.Rows.Add(ds.Tables(0).Rows(Fila)("mci_codigo"),
                                            ds.Tables(0).Rows(Fila)("mci_nombre"),
                                            ds.Tables(0).Rows(Fila)("mci_activo"))
                            Fila = Fila + 1
                        Loop
                ...
                End If
                Me.Text = "LISTADO DE MOTIVOS DE CIERRE - [ULTIMA CONSULTA: " + DateTime.Now.ToString() + "]"
            Else
    ...
    Private Sub ButtonNueva_Click(sender As Object, e As EventArgs) Handles ButtonNueva.Click
        Dim frm As frm_ingreso_motivo_cierre = New frm_ingreso_motivo_cierre
        frm.cnn = _cnn
        frm.ShowDialog()
        Call CARGA_GRILLA()
    End Sub
    ...
    Private Sub Grilla_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles Grilla.CellContentClick
        Try
            If e.ColumnIndex = 3 Then
                Dim frm As frm_ingreso_motivo_cierre = New frm_ingreso_motivo_cierre
                frm.cnn = _cnn
                frm.mci_codigo = Grilla.Rows(e.RowIndex).Cells(0).Value
                frm.ShowDialog()
                Call CARGA_GRILLA()
    ...
    Private Sub ELIMINA_REGISTRO(ByVal codigo As Integer)
        ...
        Try
            ...
            class_motivo.mci_codigo = codigo

            ds = class_motivo.MOTIVO_CIERRE_ELIMINA_REGISTRO(_msgError)
            If _msgError <> "" Then
                ds = Nothing
