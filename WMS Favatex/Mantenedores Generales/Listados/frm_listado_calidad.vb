Public Class frm_listado_calidad
    ...
    Public Property cnn() As String
        ...
        End Set
    End Property
    Private Sub frm_listado_calidad_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGA_GRILLA()
        ...
        Try
            ...
            ds = Nothing
            classCMUL.cnn = _cnn
            classCMUL.cal_codigo = 0
            classCMUL.todos = chkActivo.Checked
            ...
            If _msg = "" Then
                If ds.Tables(0).Rows.Count > 0 Then
                    If ds.Tables(0).Rows(Fila)("cal_codigo") > 0 Then
                        Do While Fila < ds.Tables(0).Rows.Count
                            Grilla.Rows.Add(ds.Tables(0).Rows(Fila)("cal_codigo"),
                                            ds.Tables(0).Rows(Fila)("cal_nombre"),
                                            ds.Tables(0).Rows(Fila)("cal_activo"))
                            Fila = Fila + 1
                        Loop
                ...
                End If
                Me.Text = "LISTADO DE CALIDAD MULTIMEDIA - [ULTIMA CONSULTA: " + DateTime.Now.ToString() + "]"
            Else
    ...
    Private Sub ButtonNueva_Click(sender As Object, e As EventArgs) Handles ButtonNueva.Click
        Dim frm As frm_ingreso_calidad = New frm_ingreso_calidad
        frm.cnn = _cnn
        frm.ShowDialog()
        Call CARGA_GRILLA()
    End Sub
    ...
    Private Sub Grilla_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles Grilla.CellContentClick
        Try
            If e.ColumnIndex = 3 Then
                Dim frm As frm_ingreso_calidad = New frm_ingreso_calidad
                frm.cnn = _cnn
                frm.cal_codigo = Grilla.Rows(e.RowIndex).Cells(0).Value
                frm.ShowDialog()
                Call CARGA_GRILLA()
    ...
    Private Sub ELIMINA_REGISTRO(ByVal codigo As Integer)
        ...
        Try
            ds = Nothing
            classCMUL.cnn = _cnn
            classCMUL.cal_codigo = codigo

            ds = classCMUL.TIPO_MULTIMEDIA_CALIDAD_ELIMINA_REGISTRO(_msgError)
            If _msgError <> "" Then
                ds = Nothing
