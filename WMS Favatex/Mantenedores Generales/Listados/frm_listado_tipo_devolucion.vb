Public Class frm_listado_tipo_devolucion
    ...
    Public Property cnn() As String
        ...
        End Set
    End Property
    Private Sub frm_listado_tipo_devolucion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGA_GRILLA()
        ...
        Try
            ...
            class_tipo_devolucion.tdv_codigo = 0
            class_tipo_devolucion.tdv_para_documento = opt_Documentos.Checked
            class_tipo_devolucion.tdv_para_picking = opt_picking.Checked
            class_tipo_devolucion.todos = chkActivo.Checked
            If class_tipo_devolucion.todos < 0 Then
                class_tipo_devolucion.todos = 1
            End If
            _msg = ""
            ...
            If _msg = "" Then
                If ds.Tables(0).Rows.Count > 0 Then
                    If ds.Tables(0).Rows(Fila)("tdv_codigo") > 0 Then
                        Do While Fila < ds.Tables(0).Rows.Count
                            Grilla.Rows.Add(ds.Tables(0).Rows(Fila)("tdv_codigo"),
                                            ds.Tables(0).Rows(Fila)("tdv_nombre"),
                                            ds.Tables(0).Rows(Fila)("tdv_pendientepk"),
                                            ds.Tables(0).Rows(Fila)("tdv_activo"),
                                            ds.Tables(0).Rows(Fila)("tdv_documento"),
                                            ds.Tables(0).Rows(Fila)("tdv_picking"),
                                            ds.Tables(0).Rows(Fila)("tdv_fin_embarque"))
                            Fila = Fila + 1
                        Loop
                ...
                End If
                Me.Text = "LISTADO DE TIPO DE DEVOLUCIONES - [ULTIMA CONSULTA: " + DateTime.Now.ToString() + "]"
            Else
    ...
    Private Sub ButtonNueva_Click(sender As Object, e As EventArgs) Handles ButtonNueva.Click
        Dim frm As frm_ingreso_tipo_devoluciones = New frm_ingreso_tipo_devoluciones
        frm.cnn = _cnn
        frm.ShowDialog()
        Call CARGA_GRILLA()
    End Sub
    ...
    Private Sub Grilla_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles Grilla.CellContentClick
        Try
            If e.ColumnIndex = 7 Then
                Dim frm As frm_ingreso_tipo_devoluciones = New frm_ingreso_tipo_devoluciones
                frm.cnn = _cnn
                frm.tdv_codigo = Grilla.Rows(e.RowIndex).Cells(0).Value
                frm.ShowDialog()
                Call CARGA_GRILLA()
    ...
    Private Sub ELIMINA_REGISTRO(ByVal tdv_codigo As Integer)
        Dim class_tipo_devolucion As class_tipodevoluciones = New class_tipodevoluciones
        Dim ds As DataSet = New DataSet
        ...
        Try
            ds = Nothing
            class_tipo_devolucion.cnn = _cnn
            class_tipo_devolucion.tdv_codigo = tdv_codigo

            ds = class_tipo_devolucion.tipo_devolucion_elimina(_msgError)
            If _msgError <> "" Then
                ds = Nothing
