Public Class frm_listado_glosas
    ...
    Public Property cnn() As String
        ...
        End Set
    End Property
    Private Sub frm_listado_glosas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGA_GRILLA()
        ...
        Try
            ...
            class_glosas.todos = chkActivo.Checked
            ...
            If _msg = "" Then
                If ds.Tables(0).Rows.Count > 0 Then
                    If ds.Tables(0).Rows(Fila)("glo_codigo") > 0 Then
                        Do While Fila < ds.Tables(0).Rows.Count
                            Grilla.Rows.Add(ds.Tables(0).Rows(Fila)("glo_codigo"),
                                            ds.Tables(0).Rows(Fila)("glo_nombre"),
                                            ds.Tables(0).Rows(Fila)("are_nombre"),
                                            ds.Tables(0).Rows(Fila)("glo_activa"))
                            Fila = Fila + 1
                        Loop
                ...
                End If
                Me.Text = "LISTADO DE GLOSAS - [ULTIMA CONSULTA: " + DateTime.Now.ToString() + "]"
            Else
    ...
    Private Sub ButtonNueva_Click(sender As Object, e As EventArgs) Handles ButtonNueva.Click
        Dim frm As frm_ingreso_glosa = New frm_ingreso_glosa
        frm.cnn = _cnn
        frm.ShowDialog()
        Call CARGA_GRILLA()
    End Sub
    ...
    Private Sub Grilla_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles Grilla.CellContentClick
        Try
            If e.ColumnIndex = 4 Then
                Dim frm As frm_ingreso_glosa = New frm_ingreso_glosa
                frm.cnn = _cnn
                frm.glo_codigo = Grilla.Rows(e.RowIndex).Cells(0).Value
                frm.ShowDialog()
                Call CARGA_GRILLA()
    ...
    Private Sub ELIMINA_REGISTRO(ByVal codigo As Integer)
        ...
        Try
            ds = Nothing
            class_glosas.cnn = _cnn
            class_glosas.glo_codigo = codigo

            ds = class_glosas.glosa_elimina_registro(_msgError)
            If _msgError <> "" Then
                ds = Nothing
