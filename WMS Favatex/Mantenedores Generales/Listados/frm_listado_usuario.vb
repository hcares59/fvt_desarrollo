Public Class frm_listado_usuario
    ...
    Public Property cnn() As String
        ...
        End Set
    End Property
    Private Sub frm_listado_usuario_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGA_GRILLA()
        ...
        Try
            ...
            class_usuario.usu_codigo = 0
            class_usuario.todos = chkActivo.Checked
            _msg = ""
            ...
            If _msg = "" Then
                If ds.Tables(0).Rows.Count > 0 Then
                    If ds.Tables(0).Rows(Fila)("usu_codigo") > 0 Then
                        Do While Fila < ds.Tables(0).Rows.Count
                            Grilla.Rows.Add(ds.Tables(0).Rows(Fila)("usu_codigo"),
                                            ds.Tables(0).Rows(Fila)("usu_nombre"),
                                            ds.Tables(0).Rows(Fila)("uso_activo"),
                                            ds.Tables(0).Rows(Fila)("usu_asignapicking"),
                                            ds.Tables(0).Rows(Fila)("usu_enviaadespacharpicking"),
                                            ds.Tables(0).Rows(Fila)("usu_finalizapicking"),
                                            0)
                            Fila = Fila + 1
                        Loop
                    End If
                ...
                End If
                Me.Text = "LISTADO DE USUARIOS - [ULTIMA CONSULTA: " + DateTime.Now.ToString() + "]"
            Else
    ...
    Private Sub ELIMINA_REGISTRO(ByVal col_codigo As Integer)
        ...
        Try
            ds = Nothing
            class_usuario.cnn = _cnn
            class_usuario.usu_codigo = col_codigo

            ds = class_usuario.ELIMINA_REGISTRO(_msgError)
            If _msgError <> "" Then
                ds = Nothing
    ...
    Private Sub Grilla_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles Grilla.CellContentClick
        Try
            If e.ColumnIndex = 7 Then
                Dim frm As frm_ingreso_usuarios = New frm_ingreso_usuarios
                frm.cnn = _cnn
                frm.usu_codigo = Grilla.Rows(e.RowIndex).Cells(0).Value
                frm.ShowDialog()
                Call CARGA_GRILLA()
