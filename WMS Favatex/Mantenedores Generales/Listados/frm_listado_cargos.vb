Public Class frm_listado_cargos
    ...
    Public Property cnn() As String
        ...
        End Set
    End Property
    Private Sub frm_listado_cargos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGA_GRILLA()
        ...
        Try
            ...
            class_cargos.uca_codigo = 0
            class_cargos.todos = chkActivo.Checked
            If class_cargos.todos < 0 Then
                class_cargos.todos = 1
            End If
            _msg = ""
            ...
            If _msg = "" Then
                If ds.Tables(0).Rows.Count > 0 Then
                    If ds.Tables(0).Rows(Fila)("uca_codigo") > 0 Then
                        Do While Fila < ds.Tables(0).Rows.Count
                            Grilla.Rows.Add(ds.Tables(0).Rows(Fila)("uca_codigo"),
                                            ds.Tables(0).Rows(Fila)("uca_nombre"),
                                            ds.Tables(0).Rows(Fila)("uca_activo"))
                            Fila = Fila + 1
                        Loop
                ...
                End If
                Me.Text = "LISTADO DE CARGOS - [ULTIMA CONSULTA: " + DateTime.Now.ToString() + "]"
            Else
    ...
    Private Sub ButtonNueva_Click(sender As Object, e As EventArgs) Handles ButtonNueva.Click
        Dim frm As frm_ingreso_cargos = New frm_ingreso_cargos
        frm.cnn = _cnn
        frm.ShowDialog()
        Call CARGA_GRILLA()
    End Sub
    ...
    Private Sub Grilla_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles Grilla.CellContentClick
        Try
            If e.ColumnIndex = 3 Then
                Dim frm As frm_ingreso_cargos = New frm_ingreso_cargos
                frm.cnn = _cnn
                frm.uca_codigo = Grilla.Rows(e.RowIndex).Cells(0).Value
                frm.ShowDialog()
                Call CARGA_GRILLA()
    ...
    Private Sub ELIMINA_REGISTRO(ByVal col_codigo As Integer)
        ...
        Try
            ds = Nothing
            class_cargos.cnn = _cnn
            class_cargos.uca_codigo = col_codigo

            ds = class_cargos.elimina_registro(_msgError)
            If _msgError <> "" Then
                ds = Nothing
