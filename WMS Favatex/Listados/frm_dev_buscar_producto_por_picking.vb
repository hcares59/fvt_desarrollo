...
Public Class frm_dev_buscar_producto_por_picking
    ...
    Public Property car_codigo() As Integer
        ...
        End Set
    End Property
    Private Sub frm_dev_buscar_producto_por_picking_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGA_GRILLA()
        ...
        Try
            ...
            _msg = ""
            Grilla.Rows.Clear()
            ds = classDev.selecciona_detalle_por_piking_devolucion(_msg)
            If _msg = "" Then
                    ...
                    If ds.Tables(0).Rows(Fila)("pro_nombre") <> "" Then
                        Do While Fila < ds.Tables(0).Rows.Count
                            Grilla.Rows.Add(False, ds.Tables(0).Rows(Fila)("car_codigo"),
                                            ...
                                            0,
                                            0,
                                            ds.Tables(0).Rows(Fila)("codigounico"),
                                            ...
                                            ds.Tables(0).Rows(Fila)("codigounico"),
                                            ds.Tables(0).Rows(Fila)("pic_filadevuelta"), 0)
                            Fila = Fila + 1
                        Loop
                    Else
    ...
    Private Sub ToolStripButton1_Click(sender As Object, e As EventArgs) Handles ToolStripButton1.Click
        ...
        For Each row As DataGridViewRow In Me.Grilla.Rows
            If row.Cells(COL_FILA_DEV).Value = True And row.Cells(COL_SELECCION).Value = True Then
