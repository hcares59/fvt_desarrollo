Public Class frm_visor_facturacion_picking
    ...
    Public Property cnn() As String
        ...
        End Set
    End Property
    Private Sub frm_visor_facturacion_picking_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGA_GRILLA()
        ...
        Try
            ...
            _msg = ""
            Grilla.Rows.Clear()
            ds = classPicking.PICKING_LISTADO_VISOR_FACTURACION(_msg)
            If _msg = "" Then
    ...
    Private Sub Grilla_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles Grilla.CellContentClick
        Try
            ...
            ElseIf e.ColumnIndex = 14 Then
                Dim frm As frm_facturacion_ordenes = New frm_facturacion_ordenes
                frm.cnn = _cnn
                frm.pic_codigo = Grilla.Rows(e.RowIndex).Cells(0).Value
