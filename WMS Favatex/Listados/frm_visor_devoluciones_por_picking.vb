...
Public Class frm_visor_devoluciones_por_picking
    ...
    Public Property cnn() As String
        ...
        End Set
    End Property
    Private Sub frm_visor_devoluciones_por_picking_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGA_GRILLA()
        ...
        Try
            ...
            _msg = ""
            Grilla.Rows.Clear()
            ds = classDevolucion.devoluciones_por_picking(_msg)
            If _msg = "" Then
                If ds.Tables(0).Rows.Count > 0 Then
                    If ds.Tables(0).Rows(Fila)("car_nombre") <> "" Then
                        Do While Fila < ds.Tables(0).Rows.Count
                            Grilla.Rows.Add(ds.Tables(0).Rows(Fila)("dev_codigo"),
                                            ...
                                            ds.Tables(0).Rows(Fila)("dev_npicking"),
                    ...
                    End If
                End If
                Me.Text = "DEVOLUCION DE PRODUCTOS POR PICKING - [ULTIMA CONSULTA: " + DateTime.Now.ToString() + "]"
            Else
    ...
    Private Sub Grilla_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles Grilla.CellContentClick
        Try
            If e.ColumnIndex = 11 Then
                Dim frm As frm_devolucion_por_picking_muestra = New frm_devolucion_por_picking_muestra
                frm.cnn = _cnn
    ...
    Private Sub ButtonExportar_Click(sender As Object, e As EventArgs) Handles ButtonExportar.Click
        ...
        Try
            ...
            If respuesta = vbNo Then
                Exit Sub
            End If
            respuesta = MessageBox.Show("¿Desea exportar listado devoluciones por picking con detalle?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question)

            If respuesta = vbYes Then

                Cursor = System.Windows.Forms.Cursors.WaitCursor
                Call ExportarDatosExcel(Gril_Dev_Detalles, "LISTADO DEVOLUCIONES DE PRODUCTO POR PICKING DETALLADO")
                Cursor = System.Windows.Forms.Cursors.Default
            Else
                Cursor = System.Windows.Forms.Cursors.WaitCursor
                Call ExportarDatosExcel(Grilla, "LISTADO DEVOLUCIONES DE PRODUCTO POR PICKING")
    ...
    Private Sub carga_grilla_devoluciones_detalles()
        ...
        Try
            ...
            ds = classDevolucion.devoluciones_detalle_por_picking(_msg)
            If _msg = "" Then
                If ds.Tables(0).Rows.Count > 0 Then
                    If ds.Tables(0).Rows(Fila)("car_nombre") <> "" Then
