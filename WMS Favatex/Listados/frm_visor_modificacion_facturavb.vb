...
Public Class frm_visor_modificacion_facturavb
    ...
    Private Sub frm_visor_modificacion_facturavb_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub carga_grilla()
        ...
        Try
            ...
            If chkFacturacion.Checked = True Then
                ...
                classPicking.fecha_factura_desde = CStr(dtpFacturacionDesde.Value.Year) + mesFacturacionDesde + diafacturacionDesde
                ...
                classPicking.fecha_factura_hasta = CStr(dtpFacturacionHasta.Value.Year) + mesFacturacionHasta + diaFacturacionHasta
            Else
                classPicking.fecha_factura_desde = "19000101"
                classPicking.fecha_factura_hasta = "20501231"
            End If
            ...
            classPicking.fac_numero = IIf(txt_numero_factura.Text = "", 0, txt_numero_factura.Text)
            'classPicking.usu_codigo = GLO_USUARIO_ACTUAL
            lblTotRegistro.Text = "Registros encontrados: 0"
            _msg = ""
            Grilla.Rows.Clear()
            ds = classPicking.picking_modificacion_factura_listado(_msg)
            If _msg = "" Then
                If ds.Tables(0).Rows.Count > 0 Then
                    ...
                    End If
                End If
                Me.Text = "PICKING MODIFICACION DE FACTURAR - [ULTIMA CONSULTA: " + DateTime.Now.ToString() + "]"
            Else
    ...
    Private Sub Grilla_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles Grilla.CellContentClick
        Try
            If e.ColumnIndex = 10 Then
                Dim frm As frm_mant_factura = New frm_mant_factura
                frm.cnn = _cnn
                ...
                frm.numFactura = Grilla.Rows(e.RowIndex).Cells(5).Value
                frm.fechaFactura = Grilla.Rows(e.RowIndex).Cells(6).Value
                frm.ShowDialog()
                Call carga_grilla()
            End If
        Catch ex As Exception
    ...
    Private Sub txt_numero_factura_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_numero_factura.KeyPress
